package simulations.apiBaasLbtr

import com.intuit.karate.gatling.PreDef.{karateFeature, karateProtocol, pauseFor}
import io.gatling.core.Predef.{Simulation, configuration, csv, openInjectionProfileFactory, rampUsers,constantUsersPerSec, scenario}

import scala.concurrent.duration.DurationInt
import scala.language.postfixOps

class DomesticPayment extends Simulation{
